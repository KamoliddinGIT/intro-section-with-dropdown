...
function burger() {
  if (Click) {
    b1.style.cssText =
      " transform: rotate(45deg); width: 37px;  position: absolute;";
    b3.style.cssText =
      " transform: rotate(-r50deg); width: 37px;  position: absolute;";
    b2.style.cssText =
      "margin-right: 50px; border-color: white; background-color: white;";
    Click = false;
  } else {
