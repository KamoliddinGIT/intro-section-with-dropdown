...
function burger() {
  if (Click) {
    nav_menu.style.cssText = "display: flex;";
    body.style.cssText =
      "background-color: rgba(6, 6, 6, 0.15);  backdrop-filter: blur(3px); overflow: hidden;";
    b1.style.cssText =
    ...
    nav_menu.style.cssText = "display: none;";
    body.style.cssText = "background-color: white;  backdrop-filter: blur(0);";
