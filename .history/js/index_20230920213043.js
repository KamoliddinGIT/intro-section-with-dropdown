...
function burger() {
  if (Click) {
    h.style.cssText =
      "display: flex; height: 300px; transition: all 2s ease; border: 5px groove #000;";
    b1.style.cssText =
      " transform: rotate(45deg); width: 40px;  position: absolute;";
    b3.style.cssText =
      " transform: rotate(-45deg); width: 40px;  position: absolute;";
    b2.style.cssText =
      "margin-right: 200px; border-color: white; background-color: white;";
    Click = false;
  } else {
    h.style.cssText = "display: flex; height: opx; transition: all 2s ease;";
    b1.style.cssText = " transform: rotate(0deg); width: 40px;";
    b3.style.cssText = " transform: rotate(0deg); width: 40px;";
    b2.style.cssText = "display: block;";
    Click = true;
  }
}
